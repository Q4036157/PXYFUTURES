export const PRODUCT_EXCHANGES: Record<string, string> = {
  AP: 'CZCE', CF: 'CZCE', CJ: 'CZCE', CY: 'CZCE', FG: 'CZCE', JR: 'CZCE', MA: 'CZCE', OI: 'CZCE', PF: 'CZCE', PK: 'CZCE', PL: 'CZCE', PM: 'CZCE', PR: 'CZCE', PX: 'CZCE', RI: 'CZCE', RM: 'CZCE', RS: 'CZCE', SA: 'CZCE', SF: 'CZCE', SH: 'CZCE', SM: 'CZCE', SR: 'CZCE', TA: 'CZCE', UR: 'CZCE', WH: 'CZCE', ZC: 'CZCE', LR: 'CZCE',
  A: 'DCE', B: 'DCE', BB: 'DCE', BZ: 'DCE', C: 'DCE', CS: 'DCE', EB: 'DCE', EG: 'DCE', FB: 'DCE', I: 'DCE', J: 'DCE', JD: 'DCE', JM: 'DCE', L: 'DCE', LG: 'DCE', LH: 'DCE', M: 'DCE', P: 'DCE', PG: 'DCE', PP: 'DCE', RR: 'DCE', V: 'DCE', Y: 'DCE',
  AD: 'SHFE', AG: 'SHFE', AL: 'SHFE', AO: 'SHFE', AU: 'SHFE', BR: 'SHFE', BU: 'SHFE', CU: 'SHFE', FU: 'SHFE', HC: 'SHFE', NI: 'SHFE', OP: 'SHFE', PB: 'SHFE', RB: 'SHFE', RU: 'SHFE', SN: 'SHFE', SP: 'SHFE', SS: 'SHFE', WR: 'SHFE', ZN: 'SHFE',
